...
- Click/tap destinations are captured in world coordinates. Water and flight support vertical steering. Arrow keys/A/D move; Up/W/Space rises or boosts; Down/S descends; X/J fires; E enters/exits a vehicle; Q gives a short shield burst. Automatic aiming can be toggled.
