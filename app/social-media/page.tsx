...
export const metadata: Metadata = pageMetadata("Social Media Content & Reporting", "Social-media strategy, branded content, scheduling and reporting for Gqeberha businesses.", "/social-media");
...
export default function SocialMediaPage() {
  ...
  return <>
    <PageHero eyebrow="SOCIAL MEDIA" title="Content that keeps your brand moving." copy="Clear strategy, consistent content and useful reporting for brands that want to show up with purpose." accent="purple" visual="social"/>
