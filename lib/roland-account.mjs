...
/** @param {{databasePath?: string, databaseUrl?: string, origin?: string, origins?: string[], local?: boolean, adminEmail?: string, bootstrapToken?: string}} options */
export async function createGameService({databasePath,databaseUrl,origin,origins=[],local=false,adminEmail='',bootstrapToken=''}={}){
